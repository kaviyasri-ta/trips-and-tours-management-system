...
?>
	...
	<table border='1' cellspacing='0' class="table table-bordered table-hover table-striped table-condensed;">
		...
		-->
		<?php
		$query= mysql_query("Select A.BookingCode,A.EntryDate,C.CustomerCode,B.CustomerName,C.ScheduleCode,C.SeatsRequired,C.Status,A.Amount,A.Mode,A.Description From Payment A,CustomerTable B,Booking C Where A.BookingCode=C.BookingCode and C.CustomerCode=B.CustomerCode and C.CustomerCode='" . $_SESSION['username'] . "'", $con);
